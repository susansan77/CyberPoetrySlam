 ...
 */
	public void testExploreWords(){
		ArrayList<Word> wrds=this.r.getWords();
		this.r.exploreWords(Sortby.initial, true, wrds);
		wrds=this.r.getWords();
		this.r.exploreWords(Sortby.type, true, wrds);
		wrds=this.r.getWords();
		this.r.exploreWords(Sortby.initial, false, wrds);
		wrds=this.r.getWords();
		this.r.exploreWords(Sortby.type, false, wrds);
	}
	/**
