...
public class testBrokerManager extends TestCase {
	...
	protected void setUp() throws Exception {
		ArrayList<Word> wrds=new ArrayList<Word>();
		  ...
		  Word w1=new Word(10,10, 0,"ask", WordType.verb);
		  Word w2=new Word(11,20, 0,"be", WordType.verb);
		  Word w3=new Word(12,30, 0,"beat", WordType.verb);
		  Word w4=new Word(13,20, 0,"blow", WordType.verb);
		  Word w5=new Word(14,20, 0,"do", WordType.verb);
		  Word w6=new Word(60,20, 0,"dream", WordType.verb);
		  wrds.add(w1);
		  wrds.add(w2);
		  wrds.add(w3);
		  wrds.add(w4);
	...
	public void testProcess(){
		...
		bmr.process(bmr.broker, "MATCH_SWAP:"+"b2e73f0f-daf2-4fce-912d-9617f3d05ed9:"+bmr.getID()+":1:verb:do:verb:ask:");
		//matchswap->failed
		bmr.process(bmr.broker, "MATCH_SWAP:"+"b2e73f0f-daf2-4fce-912d-9617f3d05ed9:"+bmr.getID()+":1:verb:dream:adj:great:");
//		//matchswap->success/star
		bmr.process(bmr.broker, "MATCH_SWAP:"+"b2e73f0f-daf2-4fce-912d-9617f3d05ed9:"+bmr.getID()+":1:verb:dream:verb:*:");
		bmr.process(bmr.broker, "MATCH_SWAP:"+"b2e73f0f-daf2-4fce-912d-9617f3d05ed9:"+bmr.getID()+":1:verb:dream:*:*:");	
		bmr.process(bmr.broker, "MATCH_SWAP:"+"b2e73f0f-daf2-4fce-912d-9617f3d05ed9:"+bmr.getID()+":2:noun:verb:Beauty:ask:*:adj:*:aba:");

		//confirm->requestor
		bmr.process(bmr.broker, "CONFIRM_SWAP:"+bmr.getID()+":b2e73f0f-daf2-4fce-912d-9617f3d05ed9:1:verb:ask:verb:dream:");
		//confirm->acceptor
		bmr.process(bmr.broker, "CONFIRM_SWAP:"+"b2e73f0f-daf2-4fce-912d-9617f3d05ed9:"+bmr.getID()+":1:verb:beat:verb:be:");
